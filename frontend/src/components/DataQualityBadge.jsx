  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
      <div className="flex items-center justify-between mb-2">
        <h3 className="text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">{t('dataQualityBadge.title')}</h3>
      ...
      <p className="text-xs text-gray-500 dark:text-gray-400">{t('dataQualityBadge.fieldsComplete', { filled, total })}</p>
      {missing.length > 0 && (
