          ...
          <div className="mb-4 space-y-2">
            ...
            {search.cfFilterRows.map((row, idx) => (
              <div key={idx} className="flex gap-2 items-center">
                ...
                <input type="text" value={row.value} onChange={e => search.updateCfFilterRow(idx, { value: e.target.value })} placeholder="value" className="flex-1 border rounded px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100" />
