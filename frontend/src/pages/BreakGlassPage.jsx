          ...
          <div className="rounded-lg border-2 border-red-500 bg-red-50 dark:bg-red-900/20 p-4 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
              ...
              <div>
                ...
                <span className="text-gray-900 dark:text-gray-100">{formatDatetime(active.created_at)}</span>
              </div>
              ...
              <div>
                ...
                <TimeRemaining expiresAt={active.expires_at} />
              </div>
            </div>
            <div className="pt-2">
              <button
                  ...
                  {history.map(s => (
                    <tr key={s.id} className="hover:bg-gray-50 dark:hover:bg-gray-750">
                      ...
                      <td className="px-4 py-3 text-gray-600 dark:text-gray-400 whitespace-nowrap">
                        {formatDuration(s.created_at, s.ended_at || (s.is_active ? null : s.expires_at))}
                      </td>
