...
| `IMAGE_TAG` | `1.34.10` | Pinned release version (GHCR tags have no `v` prefix). To upgrade, set `IMAGE_TAG=<new>` in `.env`, then run `docker compose pull && docker compose up -d` |
