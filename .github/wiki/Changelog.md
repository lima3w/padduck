...
This page summarizes major releases. For the full detailed changelog, see [CHANGELOG.md](https://github.com/lima3w/padduck/src/branch/main/CHANGELOG.md) in the repository.
